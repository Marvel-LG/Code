...
class VisualWriter():
    ...
    def save_images(self, results):
        ...
        Syn_path = os.path.join(result_path, 'Syn')
        ...
        Mask_path_abs = os.path.join(result_path, 'Mask_abs')
        os.makedirs(Mask_path_abs, exist_ok=True)
        Process_path = os.path.join(result_path, 'Process')
        os.makedirs(Process_path, exist_ok=True)
        Mask_syn_path = os.path.join(result_path, 'Mask_syn')
        os.makedirs(Mask_syn_path, exist_ok=True)
